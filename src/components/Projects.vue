...
const projects = ref([
  { id: 1, name: "Portfolio Website", languages: ["JavaScript", "SCSS", "CSS", "HTML"], frameworks: ["Vue"], features: [], img: "https://images.unsplash.com/photo-1729541777356-e28f6cd67fb6?q=80&w=1970&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", summary: "A static webpage to demo a few skills and act as a portfolio", link: "#"},
  { id: 2, name: "Card Trading Website", languages: ["JavaScript", "Python", "SQL", "CSS", "HTML"], frameworks: ["Flask"], features: ["CRUD", "Authorisation"], img: "https://images.unsplash.com/photo-1621568670868-24a7dfc590e9?q=80&w=2071&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", summary: "A simple website where users open chests, and can trade virtual cards using a virtual currency"},
  { id: 3, name: "Nelnorth Wiki", languages: ["JavaScript", "SCSS", "CSS", "HTML"], frameworks: ["Vue"], features: [], img: "https://images.unsplash.com/photo-1516780236580-ef416334d5b4?q=80&w=1996&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", summary: "A wiki based off of a TTRPG"},
  { id: 4, name: "Nelnorth App", languages: ["QML", "Python", "NoSQL", "JSON"], frameworks: ["Qt", "PySide"], features: ["Singleton", "Factory Method", "CRUD", "Google Firebase", "Authorisation", "Automation"], img: "https://images.unsplash.com/photo-1524135329990-07660cd5bf10?q=80&w=1965&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", summary:"A digital toolset for a TTRPG to assist players and automatically save their progress. Similar to dndbeyond.com"},
...
const activeMenu = computed(() => {
  ...
  return Object.keys(filterMenus).reduce((a, menu, i) => (
    ...
    // inialValue must be -1 in case of no active menu
  ), -1)
})
